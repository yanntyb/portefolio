            ...
            if(!this.display && document.querySelector("#nav").dataset.display === "true"){
                ...
                for(let i of Object.keys(data)){
                    if(data[i].strict === true){
                        this.child.push(new _Competence__WEBPACK_IMPORTED_MODULE_0__.Competence(this.div,index,data[i], true));
                    }
                    else{
                        this.child.push(new _Competence__WEBPACK_IMPORTED_MODULE_0__.Competence(this.div,index,data[i], false));
                    }
...
new _classes_CompetenceListe__WEBPACK_IMPORTED_MODULE_5__.CompetenceListe(document.querySelector("#pres-4"),"contact");
